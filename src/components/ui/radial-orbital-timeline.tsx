  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-[#EF4444] via-[#F87171] to-[#DC2626] animate-pulse flex items-center justify-center z-10">
          ...
          {mounted && timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-72 bg-white border-gray-200 shadow-2xl shadow-gray-200/50 overflow-visible">
                      ...
                      <div className="mt-4 pt-3 border-t border-gray-100">
                        <div className="flex justify-between items-center text-xs mb-1">
                          <span className="flex items-center">
                            <Zap size={10} className="mr-1 text-[#EF4444]" />
                            Utilization Index
                          </span>
                            ...
                            {item.relatedIds.map((relatedId) => {
                              ...
                              return (
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  className="flex items-center h-7 px-2.5 py-0 text-[10px] rounded-full border-gray-200 bg-gray-50 hover:bg-gray-100 text-gray-600 hover:text-gray-900 transition-all font-medium"
                                  onClick={(e) => {
                                    e.stopPropagation();
