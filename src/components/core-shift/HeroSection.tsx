      ...
      <AuroraBackground className="h-auto py-20 px-6">
        <div className="flex flex-col items-center max-w-7xl mx-auto">
          ...
          <motion.h1
            ...
            className="mb-4 text-center text-4xl font-black leading-tight text-zinc-900 md:text-5xl lg:text-[64px] tracking-tight"
          >
          ...
          <motion.p
            ...
            className="mb-8 max-w-[600px] text-center text-base leading-relaxed text-zinc-600 md:text-lg font-medium"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="rounded-lg bg-[#EF4444] px-10 py-4 text-lg font-bold text-white shadow-xl shadow-red-500/20 transition-all hover:shadow-2xl hover:bg-[#D93636]"
          >
            Request a Demo
          </motion.button>
        </div>
